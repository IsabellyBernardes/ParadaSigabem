...
const DestinationScreen: React.FC = () => {
  ...
  // Renderiza o mapa com marcador de origem e destino
...
<html>
  ...
  <body>
    ...
    <script>
      ...
      const dest = [${destLocation.latitude}, ${destLocation.longitude}];
      const map = L.map('map', { zoomControl:true, attributionControl:false });
      L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', { maxZoom:20 }).addTo(map);
      // ajusta bounds para ambos
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.originField}>
          <TouchableOpacity style={styles.originButton}>
            <Icon name="location-sharp" size={16} color="#d50000" />
            <Text style={styles.originButtonText}>{origin}</Text>
          </TouchableOpacity>
        </View>
      ...
      {/* Bottom Nav (igual LocationScreen) */}
...
const styles = StyleSheet.create({
  ...
  originField: { flexDirection: 'row', alignItems: 'center' },
  originButton: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  originButtonText: { marginLeft: 8, fontSize: 16, color: '#000' },
  inputContainer: {
    flexDirection: 'row',
    backgroundColor: '#f1f1f1',
    borderRadius: 8,
